...
export function Badge({ size = 180 }: Props) {
  return (
    ...
    >
      ...
      <circle cx="80" cy="80" r="56" fill="var(--surface-card-raised)" />
      <circle
        cx="80"
        cy="80"
        r="56"
      ...
      />
      {/* mountain + trail */}
      <path d="M46 100 L68 62 L84 88 L96 72 L116 100 Z" fill="var(--accent-secondary)" />
      <path
        ...
        fill="none"
      />
      <circle cx="68" cy="46" r="6" fill="var(--mascot-fur)" />
    </svg>
  );
}
